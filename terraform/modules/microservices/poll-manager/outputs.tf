output "resources_hash" {
  value = sha1(jsonencode([
    ...
    aws_api_gateway_method_response.patch_ok,
    aws_api_gateway_method_response.patch_bad_request,
    aws_api_gateway_method_response.patch_internal_server_error,
    aws_api_gateway_method_response.patch_not_found,
